...
export interface RenExBalancesContract {
    ...
    traderBalances(index_0: string, index_1: string, options?: Tx): Promise<BNLike>;
    SIGNAL_DELAY(options?: Tx): Promise<BNLike>;
    ...
    traderWithdrawalSignals(index_0: string, index_1: string, options?: Tx): Promise<BNLike>;
    ...
    transferBalanceWithFee(_traderFrom: string, _traderTo: string, _token: string, _value: BNLike, _fee: BNLike, _feePayee: string, options?: Tx): PromiEvent<Transaction>;
    deposit(_token: string, _value: BNLike, options?: Tx): PromiEvent<Transaction>;
    withdraw(_token: string, _value: BNLike, _signature: string, options?: Tx): PromiEvent<Transaction>;
